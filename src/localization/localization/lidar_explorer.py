...
class LidarExplorer(Node):
    ...
    def scan_callback(self, msg: LaserScan):
        ...
        front_start = int((num_ranges * (270 + 30)) / 360)                 
        front_end = int((num_ranges * 30) / 360)                            
        ...
        right_start = int((num_ranges * (360 - 150)) / 360)         
        right_end = int((num_ranges * (360 - 30)) / 360)           
